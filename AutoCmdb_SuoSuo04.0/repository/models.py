...
class BusinessUnit(models.Model):
    """
    业务线 , 外键 关联  Usergroup ,就是多个人
    """
    name = models.CharField('业务线', max_length=64, unique=True)
    contact = models.ForeignKey('UserGroup', related_name='c', verbose_name='业务联系人', on_delete=models.CASCADE )
    manager = models.ForeignKey('UserGroup', related_name='m', verbose_name='系统管理员', on_delete=models.CASCADE)
...
class Asset(models.Model):
    ...
    business_unit = models.ForeignKey('BusinessUnit', verbose_name='所属业务线', null=True, blank=True, on_delete=models.CASCADE)

    tag = models.ManyToManyField('Tag')

    latest_date = models.DateField(null=True)  # 最后修改时间
...
class Server(models.Model):
    ...
    sn = models.CharField('SN号', max_length=64, db_index=True)  # 默认 第一个 参数为  verbose_name
